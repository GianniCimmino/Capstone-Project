          ...
          <Row>
            ...
            <Col className="m-5 text-white">
              ...
              <ul>
                ...
                <li>
                  <strong>Connessione Internet:</strong> Connessione a banda
                  larga
                </li>
              </ul>
              ...
              <ul>
                ...
                <li>
                  <strong>Spazio su Disco:</strong> SSD con 50 GB di spazio
                  libero
                </li>
                <li>
          ...
          <Row className="d-flex justify-content-center">
            <Col>
              <img
                src={product.imageUrl}
                alt={product.title}
                style={{ width: "60vh", height: "60vh", margin: "10vh" }}
              ></img>
            </Col>
            <Col>
